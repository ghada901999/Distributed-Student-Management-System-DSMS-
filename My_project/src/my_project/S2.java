 ...
 */
public class S2 {
    public  static  File_Helper file=new File_Helper("D2.txt");
    public static void main(String[] args) {
         Change_Mark g1=new Change_Mark();
        g1.f=file;
        g1.time=TimeUnit.SECONDS.toMillis(15);
        g1.num=2;
         Change_Mark g2=new Change_Mark();
        g2.f=file;
        g2.time=TimeUnit.SECONDS.toMillis(17);
        g2.num=-2;
    ...
    public void run() {
        ...
        try{
            ...
            if(read.split("&")[0].equals("s")){
                S2.file.Data_save(read.split("&")[1]);
                dout.writeUTF("Saved");
            }
            else {
                ...
                int op=Integer.parseInt(sp[0]);
                 ...
                 if(op==1){
                     String re=S2.file.Get_Data_by_id(id);
                     Std s=new Std(re);                    
